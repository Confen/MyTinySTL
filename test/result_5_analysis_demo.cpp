...
int main()
{
    ...
    std::cout << "\n2. 详细执行流程：" << std::endl;
    std::cout << "第1次循环: i=0, ++cou → cou=1, construct() 成功" << std::endl;
    std::cout << "第2次循环: i=1, ++cou → cou=2, construct() 成功" << std::endl;
    std::cout << "第3次循环: i=2, ++cou → cou=3, construct() 抛出异常" << std::endl;
    std::cout << "异常被捕获: 输出'错误', break 退出循环" << std::endl;
    std::cout << "第4次循环: i=3, ++cou → cou=4, construct() 成功" << std::endl;
    std::cout << "第5次循环: i=4, ++cou → cou=5, construct() 成功" << std::endl;
    ...
    std::cout << "\n=== 为什么 break 不起作用 ===" << std::endl;
    std::cout << "break 不起作用的原因：" << std::endl;
    ...
    std::cout << "5. 循环继续执行，直到 i < 5 为 false" << std::endl;
    ...
    std::cout << "\n=== 总结 ===" << std::endl;
    std::cout << "结果为5的原因：" << std::endl;
    std::cout << "1. ++cou 在 construct() 之前执行" << std::endl;
    std::cout << "2. 即使 construct() 失败，cou 也会递增" << std::endl;
    std::cout << "3. 异常被捕获后，循环继续执行" << std::endl;
